...
function Footer() {
  ...
  return (
    <div className='bg-black text-gray-300 py-10 px-6'>
      <div className='max-w-7xl mx-auto flex lg:items-center items-start justify-centeer gap-[40px] lg:gap-[150px] flex-col lg:flex-row'>
      ...
      <div className='border-t border-gray-700 mt-10 pt-5 text-center text-sm text-gray-500'>ⓒ {new Date().getFullYear()} LearnAI. All rights reserved</div>
    </div>
  )
}
