...
function Card({thumbnail, title, category, price, id, reviews}) {
  ...
  return (
    <div className='max-w-sm w-full bg-white rounded-2xl overflow-hidden shadow-md hover:shadow-lg transitions-all duration-300 border border-gray-300' onClick={()=>navigate(`/viewcourse/${id}`)}>
